...
public class AbstractCommande 
	...
	public int hashCode() {
		...
		result = prime * result 
				+ ((this.dateCommande == null) ? 0 
						: this.dateCommande.hashCode());
		result = prime * result 
	...
	public int compareTo(
		...
		if (this.getDateCommande() == null) {
			...
			compareDate = this.getDateCommande()
		...
		compareMontant 
		= this.getMontant().compareTo(pCommande.getMontant());
	...
	public String toStringCsv() {
		...
		= this.fournirDateFormatee(this.dateCommande);
		
		final String nomClient = this.fournirNomClient(this.client);
		final String prenomClient = this.fournirPrenomClient(this.client);
	...
	public Object getValeurColonne(
		...
		case 1:
			valeur = this.fournirDateFormatee(this.dateCommande);
			break;
		...
		case 7:
			valeur = this.fournirNomClient(this.client);
			break;

		case 8:
			valeur = this.fournirPrenomClient(this.client);
			break;
	 ...
	 * Par exemple, 25/02/1961 14:37:35
	 * <br/>
	 *
	 ...
	 */
	@Override
	public void setStatutLivraison(
